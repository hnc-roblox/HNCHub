...
v0.new("<Color=Cyan>Welcome to HNC Hub<Color=/>"):Display();
wait(0.5);
v0.new("<Color=Yellow>HNC Hub On Top<Color=/>"):Display();
wait(1);
repeat
	wait();
...
v5.Window = function(v134, v135)
	...
	v197.Text = "HNC Hub";
	v197.TextSize = 20;
	v197.TextColor3 = Color3.fromRGB(255, 255, 255);
...
v8.Image = "rbxassetid://112528931029640";
v8.Draggable = true;
		...
		if v63 then
			pcall(function()
				...
				elseif (v63 == "Fast Attack") then
					v63 = 0.07;
				elseif (v63 == "Very Fast Attack") then
					v63 = 0.04;
				elseif (v63 == "Super Fast Attack") then
					v63 = 0.02;
				end
			end);
		end
...
v69:Toggle("Bypass TP [Beta]", false, function(v406)
	v48 = v406;
end);
...
PosY = "25";
v69:Dropdown("Select Distance From Monster", {
	"1",
	"10",
	"20",
	"25",
